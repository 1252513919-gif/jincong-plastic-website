...
export default function ProductsPage() {
  return (
    <>
      ...
      <section className="border-y border-white/10 bg-graphite-900 py-16">
        <div className="section-shell">
          <Reveal className="grid gap-5 rounded-lg border border-electric-400/25 bg-electric-400/10 p-6 md:grid-cols-[1fr_auto] md:items-center">
            <div>
              <h2 className="text-2xl font-semibold text-white">没有找到完全匹配的产品？</h2>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-md bg-white px-5 py-3 text-sm font-semibold text-graphite-950 transition hover:bg-electric-400"
            >
              发送图纸获取报价
